      ...
      <header className="glass border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-6">
            ...
            <div className="flex items-center">
              <img src={UBCIcon} alt="UBC" className="h-20 w-50" style={{marginRight: 10, borderRadius: 15}} />
              <img src={RMPIcon} alt="RMP" className="h-20 w-20" style={{marginLeft: 10, borderRadius: 15}} />
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="glass overflow-hidden rounded-lg border shadow-sm">
          <nav className="flex border-b border-gray-200">
            <button
              ...
              className={`flex-1 px-6 py-4 text-center text-sm font-medium border-b-2 transition-colors duration-200 ${
                activeTab === 'professor'
                  ? 'bg-white/70 text-primary-700 border-primary-600'
                  : 'text-gray-700 border-transparent hover:bg-white/50 hover:text-gray-900'
              }`}
            >
      ...
      <footer className="glass fixed bottom-0 w-full mt-12">
        <div className="relative max-w-7xl mx-auto px-4 py-5 sm:px-6 lg:px-8">
          <div className="text-center text-sm text-gray-500">
              <p className="mt-1" style={{marginBottom: "10px"}}>Data sourced from <a href="https://www.ratemyprofessors.com" target="_blank" rel="noopener noreferrer" className="text-primary-600 underline hover:text-primary-700">RateMyProfessors</a></p>
            </div>
            <div className="text-center text-sm text-gray-500">
