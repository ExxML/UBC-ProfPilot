...
const CourseSearch = () => {
  ...
  const { loading, result, error, progress, searchDurationMs, startSearch, stopSearch, emitEvent, setProgress } = useSearch({
    ...
    timeoutErrorMessage: 'Request timed out after 3 minutes. The API service likely ran out of memory while loading course professors. Try searching a course with fewer professors.'
  });
  ...
  return (
    <div className="space-y-6">
      ...
      <ProgressDisplay
        ...
        skipTitle={progress.phase === 'professor-load' ? 'Start checking course professors' : 'Display course professors'}
      />
